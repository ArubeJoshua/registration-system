...
//            dateOfBirth = userService.parseDate(dateStr);
//        } while (userService.checkDate(dateOfBirth));
//
//        User user = new User();
...
//            String dateStr = scanner.nextLine();
//            if (dateStr.equalsIgnoreCase("menu")) displayMenu();
//            newDateOfBirth = userService.parseDate(dateStr);
//        } while (userService.checkDate(newDateOfBirth));
//
//
